...
model.add(layers.Dense(20, activation='relu', input_shape=(1000,), kernel_regularizer=regularizers.l1_l2(0.001, 0.001)))
model.add(layers.Dense(20, activation='relu', input_shape=(1000,),kernel_regularizer=regularizers.l1_l2(0.001, 0.001)))
model.add(layers.Dense(1, activation='sigmoid',kernel_regularizer=regularizers.l1_l2(0.001, 0.001)))
